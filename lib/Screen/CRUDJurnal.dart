...
import 'package:my_self/constants/color.dart';
            ...
            Row(
              ...
              children: [
                const Text(
                  'Notes',
                  style: TextStyle(
                      fontSize: 30, color: Color.fromARGB(255, 8, 8, 8)),
                ),
                IconButton(
                    onPressed: () {
                      setState(() {
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide:
                      const BorderSide(color: Color.fromARGB(0, 218, 198, 198)),
                ),
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Padding(
                        ...
                        child: Text(
                          'Edited: ${DateFormat('EEE MMM d, yyyy hh:mm a').format(filteredNotes[index].modifiedTime)}',
                          style: TextStyle(
                              fontSize: 10,
